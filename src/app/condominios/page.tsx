                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 tracking-wider w-12">Nome</th>
                        ...
                        {condominios.length === 0 ? (
                            ...
                            condominios.map((condominio, index) => (
                                <tr key={condominio.id_condominio} className="hover:bg-gray-50">
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{String(index + 1)}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{condominio.nome_condominio}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{condominio.endereco_condominio}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{condominio.cidade_condominio}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{condominio.uf_condominio}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{condominio.tipo_condominio}</td>                                    
                                </tr>
                            ))
                        )}
                    </tbody>
